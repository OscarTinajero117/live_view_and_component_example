defmodule OrganizationWeb.CoreComponents do
  @moduledoc """
  ...
  import OrganizationWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OrganizationWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OrganizationWeb.Gettext, "errors", msg, opts)
    end
  end
